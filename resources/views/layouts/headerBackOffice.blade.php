  ...
  <div class="container-fluid">
    <div class="row align-items-center py-3">
      ...
      <div class="col-6 col-md-2">
        <img src="{{ asset('img/Logo.png') }}" alt="J-KADI Sports" class="img-fluid" style="max-width: 140px;">
      </div>
      ...
      <div class="col-12 col-md-5 mt-3 mt-md-0">
        <form class="d-flex" method="GET" action="{{ route('busqueda.global') }}">
          <input
            type="search"
          ...
          <button class="btn btn-light rounded-circle d-flex align-items-center justify-content-center"
            ...
            <img src="{{ asset('img/lupa.png') }}" alt="Buscar" width="18">
          </button>
        </form>
      </div>
