                            ...
                            <div class="col-12" style="margin:8px">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                           name="tipo_documento" value="RUC"
                                           {{ old(
                                                'tipo_documento',
                                                strlen($proveedor->prv_ruc_ced) == 13 ? 'RUC' : 'CEDULA'
                                              ) == 'RUC' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                           name="tipo_documento" value="CEDULA"
                                           {{ old(
                                                'tipo_documento',
                                                strlen($proveedor->prv_ruc_ced) == 13 ? 'RUC' : 'CEDULA'
                                              ) == 'CEDULA' ? 'checked' : '' }}>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="id_ciudad"
                                        class="form-select @error('id_ciudad') is-invalid @enderror" required>
